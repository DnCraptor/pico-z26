...
#define KeyEsc 		0&0x1ff	/* ESC (Quit) */

#define KeyF1 		1&0x1ff		/* F1  (Reset) */
#define KeyF2 		2&0x1ff		/* F2  (Select) */
#define KeyF3 		3&0x1ff		/* F3  (B/W) */
#define KeyF4 		4&0x1ff		/* F4  (Color) */
#define KeyF5 		5&0x1ff		/* F5  (P0 easy) */
#define KeyF6 		6&0x1ff		/* F6  (P0 hard) */
#define KeyF7 		7&0x1ff		/* F7  (P1 easy) */
#define KeyF8 		8&0x1ff		/* F8  (P1 hard) */
#define KeyF9 		9&0x1ff		/* F9  (unassigned) */
#define KeyF10 		10&0x1ff		/* F10 (unassigned) */
#define KeyF11 		11&0x1ff		/* F11 (trace on) */
#define KeyF12 		12&0x1ff		/* F12 (trace off) */

#define Key0		60&0x1ff
#define Key1		61&0x1ff
#define Key2		62&0x1ff
#define Key3		63&0x1ff
#define Key4		64&0x1ff
#define Key5		65&0x1ff
#define Key6		66&0x1ff
#define Key7		67&0x1ff
#define Key8		68&0x1ff
#define Key9		69&0x1ff

#define KeyQ		70&0x1ff
#define KeyW		71&0x1ff
#define KeyA		72&0x1ff
#define KeyZ		73&0x1ff
#define KeyX		74&0x1ff
#define KeyC		75&0x1ff
#define KeyU		76&0x1ff
#define KeyI		77&0x1ff
#define KeyO		78&0x1ff
#define KeyJ		79&0x1ff
#define KeyK		80&0x1ff
#define KeyL		81&0x1ff
#define KeyM		82&0x1ff
#define KeyComma 	83&0x1ff	/* , */
#define KeyDot 		84&0x1ff	/* . */

#define KeyG		85&0x1ff
#define KeyH		86&0x1ff
#define KeyP		87&0x1ff
#define KeyR		88&0x1ff
#define KeyT		89&0x1ff
#define KeyY		90&0x1ff
#define KeyColon 	91&0x1ff	/* : */

#define KeyLCtrl 	92&0x1ff	/* Ctrl */
#define KeyRCtrl 	93&0x1ff	/* Ctrl */
...
#define KeyLMeta 	94&0x1ff
#define KeyRMeta 	95&0x1ff

#define KeyLAlt 	96&0x1ff
#define KeyRAlt 	97&0x1ff
/* kludges to allow testing for both CTRL (or ALT) keys at the same time */
#define KeyCtrl		98&0x1ff		/* gets overwritten with LCtrl OR RCtrl */
#define	KeyAlt		99&0x1ff		/* gets overwritten with LAlt OR RAlt OR LMeta OR Rmeta */


#define KeyLShift 	100&0x1ff
#define KeyRShift 	101&0x1ff
#define KeySlash 	102&0x1ff	/* / */
#define KeyBackSlash 103&0x1ff /* \ */

#define KeyS 		104&0x1ff		/* S (P2 left) */
#define KeyF		105&0x1ff		/* F (P2 right) */
#define KeyE		106&0x1ff		/* E (P2 up) */
#define KeyD		107&0x1ff		/* D (P2 down) */
#define KeyN		108&0x1ff		/* N (P2 fire) */
#define KeyB		109&0x1ff		/* B (P2 booster grip - trigger) */
#define KeyV		110&0x1ff		/* V (P2 booster grip - booster) */

#define KeyBackSpace 111&0x1ff /* Back Space (pause game) */
#define KeyEnter 	112&0x1ff	/* Enter (resume game) */

#define KeyEquals 	113&0x1ff	/* = (do a screen dump) */
#define KeyMinus 	114&0x1ff	/* switch between palettes */

#define KeyLeft 	115&0x1ff		/* Left arrow */
#define KeyRight 	116&0x1ff	/* Right arrow */
#define KeyUp 		117&0x1ff		/* Up arrow */
#define KeyDown 	118&0x1ff		/* Down arrow */

#define KeyPgUp 	119&0x1ff	/* scroll up */
#define KeyPgDn 	120&0x1ff	/* scroll down */
#define KeyHome 	121&0x1ff		/* back to default screen position */
#define KeyTab 		122&0x1ff		/* switch mouse control in paddle mode */

#define KPLeft		123&0x1ff
#define KPRight		124&0x1ff
#define KPUp 		125&0x1ff
#define KPDown		126&0x1ff
#define KPPgUp 		127&0x1ff
#define KPPgDn		128&0x1ff
#define KPHome 		129&0x1ff

#define KeyBackTick 130&0x1ff
